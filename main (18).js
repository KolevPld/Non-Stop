...
// 🔄 Филтри
// --------------------------------------------------
// filters се чете при всяко извикване (екранът може да е бил скрит при зареждане)
const filters = {};
...
function clearFilters() {
  const ids = ["filterType","filterMethod","filterCategory","startDate","endDate","filterStore"];

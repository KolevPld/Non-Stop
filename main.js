...
// Слуша събития от Cloudinary widget в HTML
...
async function addRecord() {
  ...
  // Бележка — директно от текстовото поле
...
function saveCustomNote(note) { /* noteSelect е скрит — не се ползва */ }
function updateNoteOptions() { /* noteSelect е скрит — не се ползва */ }

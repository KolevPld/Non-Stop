...
function updateFilterSummary(data) {
  ...
  document.getElementById("filterSummary").innerHTML = `
    <strong>Сума от филтъра:</strong> Приходи: ${summary["Приход"].toFixed(2)} лв | Разходи: ${summary["Разход"].toFixed(2)} лв | Нетно: ${net.toFixed(2)} лв
  `;
}
...
function updateSummaries() {
  ...
  document.getElementById("dailySummary").innerHTML = `📅 <strong>Днес:</strong> Приходи: ${todayIncome.toFixed(2)} лв | Разходи: ${todayExpense.toFixed(2)} лв`;
  document.getElementById("monthlySummary").innerHTML = `📆 <strong>Месец:</strong> Приходи: ${monthIncome.toFixed(2)} лв | Разходи: ${monthExpense.toFixed(2)} лв | Салдо: ${saldo} лв`;
}
...
function renderMethodSummary() {
  ...
  document.getElementById("methodSummary").innerHTML = `
    💰 Кеш: ${totals.Кеш.toFixed(2)} лв | 🏦 Банка: ${totals.Банка.toFixed(2)} лв | 💳 Карта: ${totals.Карта.toFixed(2)} лв | Общо: ${totalSum.toFixed(2)} лв
  `;
...
window.exportToExcel = () => { /* … остава както е … */ };
